            ...
            <main>
              <div class="d-flex flex-column flex-shrink-0 p-1 text-white bg-dark" style="width: 280px;">
                ...
                <ul class="nav nav-pills flex-column mb-auto">
                  ...
                  <li>
                    <a href="/Producto" class="nav-link text-white">
                      <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg>
                      Productos
                    </a>
                  </li>
                  <li>
                    <a href="/Entrada" class="nav-link text-white">
                      <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>
                      Entradas / Compras
                    </a>
                  </li>
                  <li>
                    <a href="/Receta" class="nav-link text-white">
                      <svg class="bi me-2" width="16" height="16"><use xlink:href="#grid"/></svg>
                      Recetas
                    </a>
                  </li>
                  <li>
                    <a href="/Salida" class="nav-link text-white">
                      <svg class="bi me-2" width="16" height="16"><use xlink:href="#table"/></svg>
                       Salidas / Ventas
                    </a>
                  </li>
